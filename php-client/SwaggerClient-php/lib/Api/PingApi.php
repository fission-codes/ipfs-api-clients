...
class PingApi
{
     ...
     * @return \Swagger\Client\Model\Pong
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Pong, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\Pong';
     ...
     */
    protected function pingGetRequest()
    {
