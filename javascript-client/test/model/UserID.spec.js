...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FissionsIpfsApi.UserID();
  });
  ...
  describe('UserID', function() {
    it('should create an instance of UserID', function() {
      // uncomment below and update the code to test UserID
      //var instance = new FissionsIpfsApi.UserID();
      //expect(instance).to.be.a(FissionsIpfsApi.UserID);
    });
